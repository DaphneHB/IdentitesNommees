...
class FactureSimplifiees :
    ...
    def __init__ (self, file) :
        ...
        # la descriptions des prestations contenues dans la facture  (string)
        self.prestations = None
        # le montant total HT,  le taux de tva,  le montant total de TVA
        # les autres taxes potentielles,  le montant total TTC
...
class Facture :
    ...
    Représente une facture récupérée depuis un fichier pdf
    Modèle basé sur les attentes contenues dans le cahier des charges
    Version de classe de facture en lecture complexe,  ie séparation des prestations
    """
    def __init__ (self, file) :
    	# le titre facultatif de la facture  (par defaut "Facture <nom de l'expéditeur>")  (string)
        self.titre = None # implied
        ...
        # le moyen de paiement  (objet InfoFacture)
        self.infosFacture = InfosFacture ()
        # la liste des prestations contenues dans la facture  (list<objet prestation>)
