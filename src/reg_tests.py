...
import re
caract_saut = '<br>'
bloc_text = u"Free SAS au capital de 3.441.812 Euros − B 421 938 861 Paris RCS − Siège social: 8 rue de la Ville l’Evêque 75008 Paris − N° de TVA intra communautaire: FR 604 219 388 61"
...
import unicodedata
str_adresse = u"Siège social: 8 rue de la Ville l’Evêque 75008 Paris"
print str_adresse #.decode('unicode-escape')
#str_adresse = unicodedata.normalize('NFKD', str_adresse).encode('ascii', 'ignore')
