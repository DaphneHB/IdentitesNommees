...
def convert(fname, dest_path, type_out="txt", pages=None):
    """
    ...
    dest_path = tools.recup_destination(dest_path,ext)
    ...
    if outfile:
        ...
        convert(fname,dest_path,type_out="txt")
    else:
        output = sys.stdout
...
convert(PDF_FILE, "/data/", type_out="txt")
